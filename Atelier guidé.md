...
- Choisissez "MsTest" et .Net 6.0 comme Framework de test cible (ou plus élevé si possible)
...
- A vous d'écrire le fichier FeatureFile comme vous l'imaginez avec ce que l'on a vu concernant le Gherkin et ses mots clés (Given, And, When, Then,...)
  ...
  - L'utilisateur doit être à la page game (PageHelper.GetUrl() == "http://localhost/JeuSerpent/game")
